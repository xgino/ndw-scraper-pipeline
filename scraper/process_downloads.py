...
class FileExtractor:
    def __init__(self, download_folder=None, preprocess_folder='./preprocess'):
        self.download_folder = download_folder or os.path.join(os.path.dirname(__file__), 'downloads')
        self.preprocess_folder = os.path.abspath(preprocess_folder)
