...
class CONVERT_TO_PARQUET:
    ...
    def get_verkeerboard_rd_data(self):
        try:
            ...
            logger.info(f"Completed RD data conversion to Parquet. File saved at: {self.output_folder}")
        except Exception as e:
    ...
    def get_verkeerboard_wgs_data(self):
        try:
            ...
            logger.info(f"Completed wgs84 data conversion to Parquet. File saved at: {self.output_folder}")
        except Exception as e:
    ...
    def get_verkeersborden_actueel_beeld_data(self):
        try:
            ...
            logger.info(f"Completed verkeersborden_actueel_beeld data conversion to Parquet. File saved at: {self.output_folder}")
        except Exception as e:
